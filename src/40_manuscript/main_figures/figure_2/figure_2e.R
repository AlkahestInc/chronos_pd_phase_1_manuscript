...
here::i_am("src/40_manuscript/main_figures/figure_2/figure_2e.R")

input_dataset_file <- glue::glue("{get_config()$input_dir}/name=chronos_alamar_merged-pd_master_summary_2/version=29830/dataset.parquet")
output_figure_file <- glue::glue("{get_config()$output_dir}/main_figures/figure_2e.pdf")
