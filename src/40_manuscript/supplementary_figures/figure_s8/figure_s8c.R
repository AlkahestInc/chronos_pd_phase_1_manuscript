...
here::i_am("src/40_manuscript/supplementary_figures/figure_s8/figure_s8c.R")
...
output_figure_file <- glue::glue("{get_config()$output_dir}/supplementary_figures/figure_s8/figure_s8c.pdf")
