...
here::i_am("src/20_analyses/lmm/alamar.R")
...
output_intermediate_result_file <- glue::glue("{get_config()$output_dir}/lmm/intermediate/alamar.screening.rds")
output_result_file <- glue::glue("{get_config()$output_dir}/lmm/alamar.screening.rds")
