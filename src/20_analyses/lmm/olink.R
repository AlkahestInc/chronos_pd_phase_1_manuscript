...
here::i_am("src/20_analyses/lmm/olink.R")
...
output_intermediate_result_file <- glue::glue("{get_config()$output_dir}/lmm/intermediate/olink.screening.rds")
output_result_file <- glue::glue("{get_config()$output_dir}/lmm/olink.screening.rds")
