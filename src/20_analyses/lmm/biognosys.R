...
here::i_am("src/20_analyses/lmm/biognosys.R")
...
output_intermediate_result_file <- glue::glue("{get_config()$output_dir}/lmm/intermediate/biognosys.screening.rds")
output_result_file <- glue::glue("{get_config()$output_dir}/lmm/biognosys.screening.rds")
...
grouppd_table |>
  dplyr::filter(adj.p < 0.05) # 0 based on adjp; 614 with p
