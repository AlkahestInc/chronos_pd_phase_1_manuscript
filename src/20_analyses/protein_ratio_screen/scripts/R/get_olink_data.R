...
#!/usr/bin/env Rscript
# Usage: scripts/R/get_olink_data.R --output assets/olink.parquet

here::i_am("scripts/R/get_olink_data.R")

#####
# Define commandline arguments
#####
option_list <- list(
  optparse::make_option(c("-o", "--output"), type = "character", help = "Olink output data file (parquet format)"),
...
data <- glue::glue(
  ...
  name = "Chronos_phase1_proteomics_olink_table",
  version = "none"
) |>
  arrow::open_dataset() |>
  dplyr::collect() |>
